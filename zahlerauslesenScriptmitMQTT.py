...
while(1):
    ...
    print(str(f'{HV_KompletteBlindleistung:.2f}')+"W -Alle Phasen Blindleistung")
    ...
    print(str(f'{HV_Gesamte_verbrauchte_Blindleistung:.4f}')+"kWh Gesamte Verbrauchte Blind -Wh\n")

    client.publish("zaehler/Hausverbrauch/AktuelleWirkleistung",HV_KompletteWirkleistung) #publish
